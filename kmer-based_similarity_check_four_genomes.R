...
if (!interactive()) {
  ...
  option_list <- list(
    ...
    make_option(c("-g3", "--genome_path3"), type="character", default=NULL, help="Path to genome 3", metavar="character"),
    make_option(c("-g4", "--genome_path4"), type="character", default=NULL, help="Path to genome 4", metavar="character")
  )
  ...
  if (is.null(opt$genome_path1) | is.null(opt$genome_path2) | is.null(opt$genome_path3) | is.null(opt$genome_path4)){
  ...
  opt <- list()
  opt$genome_path1 <- "../Downloads/rlanei_1_flye.fasta"
  opt$genome_path2 <- "../Downloads/rlanei_1_hicanu.fasta"
  opt$genome_path3 <- "../Downloads/rlanei_15_flye.fasta"
  opt$genome_path4 <- "../Downloads/rlanei_15_hicanu.fasta"
}
...
genome_files <- c(
  ...
  "Genome3" = opt$genome_path3,
  "Genome4" = opt$genome_path4
)
